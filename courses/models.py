...
class Course(models.Model):
    owner = models.ForeignKey(User, related_name='course_user', on_delete=models.CASCADE)
    subject = models.ForeignKey(Subject, related_name='course_subject', on_delete=models.CASCADE)
    title = models.CharField(max_length=200)
